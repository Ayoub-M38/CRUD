...
<div class="display-3 text-center mt-5 text-primary font-weight-bold">suppression de produits</div>
    <div class="alert alert-dismissible alert-danger mt-5 p-5">
        <strong>ATTENTION</strong> <a href="listeProduit.php" class="alert-link">Retour a la liste des produits</a> le produit concerner va etre supprimé.
        <?php
    ...
    <div class="text-center">
        <a href="listeProduit.php" class="btn btn-success btn-lg m-5">ANNULER</a>
    </div>
